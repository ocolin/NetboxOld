...
use Cruzio\lib\Netbox\Models\DCIM\ConsolePortTemplates;
...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new ConsolePortTemplates();
        $d = new Data();
        $d->set( 'name', 'testConsolePortTemplate' );
...
---------------------------------------------------------------------------- */
    ...
    public function testPutDetail( int $id ) : void
    {
        $o = new ConsolePortTemplates();
        $d = new Data();
        $d->set( 'name', 'updateConsolePortTemplate' );
        $d->set( 'device_type', self::$devtype->id );
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new ConsolePortTemplates();
        $d = new Data();
        $d->set( 'name', 'patchConsolePortTemplate' );
        $d->set( 'device_type', self::$devtype->id );
