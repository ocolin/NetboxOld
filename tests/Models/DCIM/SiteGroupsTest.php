...
use Cruzio\lib\Netbox\Models\DCIM\SiteGroups;
use Cruzio\lib\Netbox\Data\DCIM\SiteGroups AS Data;
...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new SiteGroups();
        $d = new Data();
        $d->name = 'testSiteGroups';
        $d->slug = 'testSiteGroups';
...
---------------------------------------------------------------------------- */
    ...
    public function testPutDetail( int $id ) : void
    {
        $o = new SiteGroups();
        $d = new Data();
        $d->name = 'updateSiteGroup';
        $d->slug = 'updateSiteGroup';
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new SiteGroups();
        $d = new Data();
        $d->name = 'patchSiteGroup';
        $d->slug = 'patchSiteGroup';
