...
use Cruzio\lib\Netbox\Models\DCIM\PowerPortTemplates;
...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new PowerPortTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_PowerPortTemp-Post' );
...
---------------------------------------------------------------------------- */
    ...
    public function testPutDetail( int $id ) : void
    {
        $o = new PowerPortTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_PowerPortTemp-Put' );
        $d->set( 'device_type', self::$devtype->id );
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new PowerPortTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_PowerPortTemp-Patch' );
