...
use Cruzio\lib\Netbox\Models\DCIM\InventoryItemTemplates;
...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new InventoryItemTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_InvItemTemp-Post' );
...
---------------------------------------------------------------------------- */
    ...
    public function testPutDetail( int $id ) : void
    {
        $o = new InventoryItemTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_InvItemTemp-Put' );
        $d->set( 'device_type', self::$devtype->id );
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new InventoryItemTemplates();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_InvItemTemp-Patch' );
