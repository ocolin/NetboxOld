...
use Cruzio\lib\Netbox\Models\DCIM\DeviceTypes;
...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new DeviceTypes();
        $d = new Data();
        $d->set( 'model', 'testDeviceType' );
        $d->set( 'slug', 'testDeviceType' );
        $d->set( 'manufacturer', self::$manf->id );
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new DeviceTypes();
        $d = new Data();
        $d->set( 'model', 'testDeviceTypePatch' );
