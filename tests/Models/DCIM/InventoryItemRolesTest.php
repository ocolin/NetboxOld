...
---------------------------------------------------------------------------- */
    ...
    public function testPostDetail() : int
    {
        $o = new InventoryItemRoles();
        $d = new Data();
        $d->set( 'name', 'testInventoryItemRolesPost' );
        $d->set( 'slug', 'testInventoryItemRolesPost' );
...
---------------------------------------------------------------------------- */
    ...
    public function testPutDetail( int $id ) : void
    {
        $o = new InventoryItemRoles();
        $d = new Data();
        $d->set( 'name', 'PHPUnit_InvItemRolePut' );
        $d->set( 'slug', 'PHPUnit_InvItemRolePut' );
...
---------------------------------------------------------------------------- */
    ...
    public function testPatchDetail( int $id ) : void
    {
        $o = new InventoryItemRoles();
        $d = new Data();
        $d->set( 'name', 'patchInventoryItemRoles' );
