...
use Cruzio\lib\Netbox\Controllers\DCIM\DeviceBays;
use Exception;
use PHPUnit\Framework\Attributes\Depends;

final class DeviceBaysTest extends TestDCIM
{
...
----------------------------------------------------------------------------- */
    ...
    public function testOptionsDeviceBay() : void
    {
        $o = new DeviceBays();
        $result = $o->options();
        ;
...
----------------------------------------------------------------------------- */
    ...
    public function testCreateDeviceBayBad() : void
    {
        $o = new DeviceBays();
...
----------------------------------------------------------------------------- */
     ...
     * @throws Exception
     */
    public function testCreateDeviceBay() : int
    {
        $result = self::createDeviceBay( device_id: self::$device->id );
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreateDeviceBay')]
    public function testReplaceDeviceBayBad( int $id ) : void
    {
        $o = new DeviceBays();
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreateDeviceBay')]
    public function testReplaceDeviceBay( int $id ) : void
    {
        $o = new DeviceBays();
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreateDeviceBay')]
    public function testUpdateDeviceBay( int $id ) : void
    {
        $o = new DeviceBays();
...
----------------------------------------------------------------------------- */
    ...
    #[Depends('testCreateDeviceBay')]
    public function testDeleteDeviceBay( int $id ) : void
    {
        $o = new DeviceBays();
