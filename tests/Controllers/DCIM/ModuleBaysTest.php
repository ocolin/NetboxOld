...
use Cruzio\lib\Netbox\Controllers\DCIM\ModuleBays;
use Exception;
use PHPUnit\Framework\Attributes\Depends;

final class ModuleBaysTest extends TestDCIM
{
    ...
    public function testOptionsModuleBay() : void
    {
        $o = new ModuleBays();
        $result = $o->options();
        ;
    ...
    public function testCreateModuleBayBad() : void
    {
        $o = new ModuleBays();
     ...
     * @throws Exception
     */
    public function testCreateModuleBay() : int
    {
        $result = self::createModuleBay( device_id: self::$device->id );
    ...
    #[Depends('testCreateModuleBay')]
    public function testGetModuleBay( int $id ) : void
    {
        $o = new ModuleBays();
        $result = $o->get( id: $id );
    ...
    public function testGetListModuleBay() : void
    {
        $o = new ModuleBays();
        $result = $o->get();
     ...
     */
    #[Depends('testCreateModuleBay')]
    public function testReplaceModuleBayBad( int $id ) : void
    {
        $o = new ModuleBays();
     ...
     */
    #[Depends('testCreateModuleBay')]
    public function testReplaceModuleBay( int $id ) : void
    {
        $o = new ModuleBays();
     ...
     */
    #[Depends('testCreateModuleBay')]
    public function testUpdateModuleBay( int $id ) : void
    {
        $o = new ModuleBays();
    ...
    #[Depends('testCreateModuleBay')]
    public function testDeleteModuleBay( int $id ) : void
    {
        $o = new ModuleBays();
