...
use Cruzio\lib\Netbox\Controllers\DCIM\PowerOutlets;
use Exception;
use PHPUnit\Framework\Attributes\Depends;

final class PowerOutletsTest extends TestDCIM
{
...
----------------------------------------------------------------------------- */
    ...
    public function testOptionsPowerOutlet() : void
    {
        $o = new PowerOutlets();
        $result = $o->options();
...
----------------------------------------------------------------------------- */
    ...
    public function testCreatePowerOutletBad() : void
    {
        $o = new PowerOutlets();
...
----------------------------------------------------------------------------- */
     ...
     * @throws Exception
     */
    public function testCreatePowerOutlet() : int
    {
        $result = self::createPowerOutlet( device_id: self::$device->id );
...
----------------------------------------------------------------------------- */
    ...
    #[Depends('testCreatePowerOutlet')]
    public function testGetPowerOutlet( int $id ) : void
    {
        $o = new PowerOutlets();
        $result = $o->get( id: $id );
...
----------------------------------------------------------------------------- */
    ...
    public function testGetListPowerOutlet() : void
    {
        $o = new PowerOutlets();
        $result = $o->get();
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreatePowerOutlet')]
    public function testReplacePowerOutletBad( int $id ) : void
    {
        $o = new PowerOutlets();
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreatePowerOutlet')]
    public function testReplacePowerOutlet( int $id ) : void
    {
        $o = new PowerOutlets();
...
----------------------------------------------------------------------------- */
     ...
     */
    #[Depends('testCreatePowerOutlet')]
    public function testUpdatePowerOutlet( int $id ) : void
    {
        $o = new PowerOutlets();
...
----------------------------------------------------------------------------- */
    ...
    #[Depends('testCreatePowerOutlet')]
    public function testDeletePowerOutlet( int $id ) : void
    {
        $o = new PowerOutlets();
