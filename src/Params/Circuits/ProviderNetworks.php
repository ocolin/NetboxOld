...
class ProviderNetworks extends Params_Core implements ParamsInterface
{
    /**
    ...
    /**
     * @var string|array<string> $service_id
     */
    protected string|array $service_id;
    protected bool $service_id__empty;

    /**
     * @var string|array<string> $service_id__ic
     */
    protected string|array $service_id__ic;

    /**
     * @var string|array<string> $service_id__ie
     */
    protected string|array $service_id__ie;

    /**
     * @var string|array<string> $service_id__iew
     */
    protected string|array $service_id__iew;

    /**
     * @var string|array<string> $service_id__isw
     */
    protected string|array $service_id__isw;

    /**
     * @var string|array<string> $service_id__n
     */
    protected string|array $service_id__n;

    /**
     * @var string|array<string> $service_id__nic
     */
    protected string|array $service_id__nic;

    /**
     * @var string|array<string> $service_id__nie
     */
    protected string|array $service_id__nie;

    /**
     * @var string|array<string> $service_id__niew
     */
    protected string|array $service_id__niew;

    /**
     * @var string|array<string> $service_id__nisw
     */
    protected string|array $service_id__nisw;
