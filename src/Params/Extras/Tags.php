...
class Tags extends Params_Core implements ParamsInterface
{
    /**
    ...
    /**
     * @var string|array<string> $content_type
     */
    protected string|array $content_type;
    ...
    /**
     * @var int|array<int> $object_types
     */
    protected int|array $object_types;

    /**
     * @var int|array<int> $object_types__n
     */
    protected int|array $object_types__n;
