...
class FrontPorts extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var string|array<string> $rack_n
     */
    protected string|array $rack_n;
    ...
    /**
     * @var string|array<string> $virtual_chassis_n
     */
    protected string|array $virtual_chassis_n;
