...
class PowerPorts extends Params_Core implements ParamsInterface
{

    /**
     * @var array<int> $allocated_draw
     */
    protected array $allocated_draw;

    protected bool $allocated_draw__empty;

    /**
     * @var array<int> $allocated_draw__gt
     */
    protected array $allocated_draw__gt;

    /**
     * @var array<int> $allocated_draw__gte
     */
    protected array $allocated_draw__gte;

    /**
     * @var array<int> $allocated_draw__lt
     */
    protected array $allocated_draw__lt;

    /**
     * @var array<int> $allocated_draw__lte
     */
    protected array $allocated_draw__lte;

    /**
     * @var array<int> $allocated_draw__n
     */
    protected array $allocated_draw__n;
    ...
    /**
     * @var array<int> $maximum_draw
     */
    protected array $maximum_draw;
    protected bool $maximum_draw__empty;

    /**
     * @var array<int> $maximum_draw__gt
     */
    protected array $maximum_draw__gt;

    /**
     * @var array<int> $maximum_draw__gte
     */
    protected array $maximum_draw__gte;

    /**
     * @var array<int> $maximum_draw__lt
     */
    protected array $maximum_draw__lt;

    /**
     * @var array<int> $maximum_draw__lte
     */
    protected array $maximum_draw__lte;

    /**
     * @var array<int> $maximum_draw__n
     */
    protected array $maximum_draw__n;
