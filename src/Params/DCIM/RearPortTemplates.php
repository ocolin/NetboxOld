...
class RearPortTemplates extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var array<int> $positions
     */
    protected array $positions;
    protected bool $positions__empty;

    /**
     * @var array<int> $positions__gt
     */
    protected array $positions__gt;

    /**
     * @var array<int> $positions__gte
     */
    protected array $positions__gte;

    /**
     * @var array<int> $positions__lt
     */
    protected array $positions__lt;

    /**
     * @var array<int> $positions__lte
     */
    protected array $positions__lte;

    /**
     * @var array<int> $positions__n
     */
    protected array $positions__n;
    protected string $q;
