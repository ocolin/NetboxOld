...
class RearPortTemplates extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var int|array<int> $positions
     */
    protected int|array $positions;
    protected bool $positions__empty;

    /**
     * @var int|array<int> $positions__gt
     */
    protected int|array $positions__gt;

    /**
     * @var int|array<int> $positions__gte
     */
    protected int|array $positions__gte;

    /**
     * @var int|array<int> $positions__lt
     */
    protected int|array $positions__lt;

    /**
     * @var int|array<int> $positions__lte
     */
    protected int|array $positions__lte;

    /**
     * @var int|array<int> $positions__n
     */
    protected int|array $positions__n;
    protected string $q;
