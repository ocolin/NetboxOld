...
{
    /**
     * @var int|array<int> $asn
     */
    protected int|array $asn;

    /**
     * @var int|array<int> $asn__n
     */
    protected int|array $asn__n;

    /**
     * @var int|array<int> $asn_id
     */
    protected int|array $asn_id;

    /**
     * @var int|array<int> $asn_id__n
     */
    protected int|array $asn_id__n;
    ...
    /**
     * @var string|array<string> $facility
     */
    protected string|array $facility;
    protected bool $facility__empty;

    /**
     * @var string|array<string> $facility__ic
     */
    protected string|array $facility__ic;

    /**
     * @var string|array<string> $facility__ie
     */
    protected string|array $facility__ie;

    /**
     * @var string|array<string> $facility__iew
     */
    protected string|array $facility__iew;

    /**
     * @var string|array<string> $facility__isw
     */
    protected string|array $facility__isw;

    /**
     * @var string|array<string> $facility__n
     */
    protected string|array $facility__n;

    /**
     * @var string|array<string> $facility__nic
     */
    protected string|array $facility__nic;

    /**
     * @var string|array<string> $facility__nie
     */
    protected string|array $facility__nie;

    /**
     * @var string|array<string> $facility__niew
     */
    protected string|array $facility__niew;

    /**
     * @var string|array<string> $facility__nisw
     */
    protected string|array $facility__nisw;
