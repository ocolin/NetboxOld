...
class PowerOutletTemplates extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var string|array<string> $feed_leg
     */
    protected string|array $feed_leg;

    /**
     * @var string|array<string> $feed_leg__n
     */
    protected string|array $feed_leg__n;
