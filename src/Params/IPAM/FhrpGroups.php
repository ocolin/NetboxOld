...
class FhrpGroups extends Params_Core implements ParamsInterface
{
    /**
     * @var string|array<string> $auth_key
     */
    protected string|array $auth_key;
    protected bool $auth_key__empty;

    /**
     * @var string|array<string> $auth_key__ic
     */
    protected string|array $auth_key__ic;

    /**
     * @var string|array<string> $auth_key__ie
     */
    protected string|array $auth_key__ie;

    /**
     * @var string|array<string> $auth_key__iew
     */
    protected string|array $auth_key__iew;

    /**
     * @var string|array<string> $auth_key__isw
     */
    protected string|array $auth_key__isw;

    /**
     * @var string|array<string> $auth_key__n
     */
    protected string|array $auth_key__n;

    /**
     * @var string|array<string> $auth_key__nic
     */
    protected string|array $auth_key__nic;

    /**
     * @var string|array<string> $auth_key__nie
     */
    protected string|array $auth_key__nie;

    /**
     * @var string|array<string> $auth_key__niew
     */
    protected string|array $auth_key__niew;

    /**
     * @var string|array<string> $auth_key__nisw
     */
    protected string|array $auth_key__nisw;
    ...
    protected bool $group_id__empty;

    /**
     * @var int|array<int> $group_id__gt
     */
    protected int|array $group_id__gt;

    /**
     * @var int|array<int> $group_id__gte
     */
    protected int|array $group_id__gte;

    /**
     * @var int|array<int> $group_id__lt
     */
    protected int|array $group_id__lt;

    /**
     * @var int|array<int> $group_id__lte
     */
    protected int|array $group_id__lte;
    ...
    /**
     * @var string|array<string> $protocol
     */
    protected string|array $protocol;

    /**
     * @var string|array<string> $protocol__n
     */
    protected string|array $protocol__n;

    protected string $q;

    /**
     * @var string|array<string> $related_ip
     */
    protected string|array $related_ip;
