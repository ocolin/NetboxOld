...
class RouteTargets extends Params_Core implements ParamsInterface
{
    /**
    ...
    /**
     * @var string|array<string> $exporting_vrf
     */
    protected string|array $exporting_vrf;

    /**
     * @var string|array<string> $exporting_vrf__n
     */
    protected string|array $exporting_vrf__n;

    /**
     * @var int|array<int> $exporting_vrf_id
     */
    protected int|array $exporting_vrf_id;

    /**
     * @var int|array<int> $exporting_vrf_id__n
     */
    protected int|array $exporting_vrf_id__n;
    ...
    /**
     * @var string|array<string> $importing_vrf
     */
    protected string|array $importing_vrf;

    /**
     * @var string|array<string> $importing_vrf__n
     */
    protected string|array $importing_vrf__n;

    /**
     * @var int|array<int> $importing_vrf_id
     */
    protected int|array $importing_vrf_id;

    /**
     * @var int|array<int> $importing_vrf_id__n
     */
    protected int|array $importing_vrf_id__n;
