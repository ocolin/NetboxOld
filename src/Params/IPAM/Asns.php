...
class Asns extends Params_Core implements ParamsInterface
{
    /**
     ...
     * @var bool $asn__empty
     */
    protected bool $asn__empty;

    /**
     * @var int|array<int> $asn__gt
     */
    protected int|array $asn__gt;

    /**
     * @var int|array<int> $asn__gte
     */
    protected int|array $asn__gte;

    /**
     * @var int|array<int> $asn__lt
     */
    protected int|array $asn__lt;

    /**
     * @var int|array<int> $asn__lte
     */
    protected int|array $asn__lte;
