...
class Services extends Params_Core implements ParamsInterface
{
    /**
    ...
    /**
     * @var string|array<string> $ipaddress
     */
    protected string|array $ipaddress;

    /**
     * @var string|array<string> $ipaddress__n
     */
    protected string|array $ipaddress__n;

    /**
     * @var int|array<int> $ipaddress_id
     */
    protected int|array $ipaddress_id;

    /**
     * @var int|array<int> $ipaddress_id__n
     */
    protected int|array $ipaddress_id__n;
    ...
    protected int|float $port;
    protected string $protocol;
    protected string $protocol__n;
    protected string $q;
