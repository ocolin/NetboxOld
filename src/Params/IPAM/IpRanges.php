...
class IpRanges extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var string|array<string> $end_address
     */
    protected string|array $end_address;
    ...
    /**
     * @var string|array<string> $start_address
     */
    protected string|array $start_address;
