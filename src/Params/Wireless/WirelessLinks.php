...
class WirelessLinks extends Params_Core implements ParamsInterface
{
    ...
    /**
     * @var int|array<int> $interface_a_id
     */
    protected int|array $interface_a_id;
    protected bool $interface_a_id__empty;

    /**
     * @var int|array<int> $interface_a_id__gt
     */
    protected int|array $interface_a_id__gt;

    /**
     * @var int|array<int> $interface_a_id__gte
     */
    protected int|array $interface_a_id__gte;

    /**
     * @var int|array<int> $interface_a_id__lt
     */
    protected int|array $interface_a_id__lt;

    /**
     * @var int|array<int> $interface_a_id__lte
     */
    protected int|array $interface_a_id__lte;

    /**
     * @var int|array<int> $interface_a_id__n
     */
    protected int|array $interface_a_id__n;

    /**
     * @var int|array<int> $interface_b_id
     */
    protected int|array $interface_b_id;
    protected bool $interface_b_id__empty;

    /**
     * @var int|array<int> $interface_b_id__gt
     */
    protected int|array $interface_b_id__gt;

    /**
     * @var int|array<int> $interface_b_id__gte
     */
    protected int|array $interface_b_id__gte;

    /**
     * @var int|array<int> $interface_b_id__lt
     */
    protected int|array $interface_b_id__lt;

    /**
     * @var int|array<int> $interface_b_id__lte
     */
    protected int|array $interface_b_id__lte;

    /**
     * @var int|array<int> $interface_b_id__n
     */
    protected int|array $interface_b_id__n;
